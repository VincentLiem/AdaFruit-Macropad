...
app = {               # REQUIRED dict, must be named 'app'
    ...
    'macros' : [      # List of button macros...
        ...
        (0x000000, 'Video', [Keycode.ALT, Keycode.F10]), #Save Instant Replay
        # 2nd row ----------
        ...
        # 3rd row ----------
        (0x000000, 'LIVE on/off', [Keycode.ALT, Keycode.F8]), #Toggle LIVE
        (0x000000, 'Live Pause', [Keycode.ALT, Keycode.F7]), #Pause/Resume LIVE
        (0x000000, 'Live Video', [Keycode.ALT, Keycode.F6]), #LIVE Video on/off
        # 4th row ----------
